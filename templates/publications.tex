...
%  SECTION TITLE
%-------------------------------------------------------------------------------
\cvsection{<VAR> t("publications", "Publications") </VAR>}
...
<BLOCK> for pub in publications </BLOCK>
  ...
  <BLOCK> endif </BLOCK>
  \cventry
    {<VAR> pub['type'] | latex_escape </VAR><BLOCK> if pub.get('status') and pub['status'] != 'Published' </BLOCK> — <VAR> pub['status'] | latex_escape </VAR><BLOCK> endif </BLOCK>} % type/status
    {%
